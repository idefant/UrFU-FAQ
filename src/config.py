...
site_title = "Приём, УрФУ!"
site_subtitle = "Все, что может понадобиться тебе для поступления, мы собрали на одной странице. Теперь поступить" \
                "правильно стало еще проще."
